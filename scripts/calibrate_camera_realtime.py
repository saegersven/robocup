...
print(f"BLACK AVG (BGR): {black_vals}")
print(f"BLUE AVG (BGR): {blue_vals}")
print(f"GREEN AVG (BGR): {green_vals}")
print(f"RED AVG(BGR): {red_vals}")


print("\n\n\n\n########### RESULTS (AVG) ###########")

print()
print(f"BLACK AVG (BGR): {tuple(map(np.mean, zip(*black_vals)))}")
print(f"BLUE AVG (BGR): {tuple(map(np.mean, zip(*blue_vals)))}")
print(f"GREEN AVG (BGR): {tuple(map(np.mean, zip(*green_vals)))}")
print(f"RED AVG(BGR): {tuple(map(np.mean, zip(*red_vals)))}")
